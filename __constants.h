...
extern PyObject *global_constants[101];
// ()
...
// 'w'
#define const_str_plain_w global_constants[52]
// 'b'
#define const_str_plain_b global_constants[53]
// '/'
#define const_str_slash global_constants[54]
// '\\'
#define const_str_backslash global_constants[55]
// 'path'
#define const_str_plain_path global_constants[56]
// 'basename'
#define const_str_plain_basename global_constants[57]
// 'dirname'
#define const_str_plain_dirname global_constants[58]
// 'abspath'
#define const_str_plain_abspath global_constants[59]
// 'isabs'
#define const_str_plain_isabs global_constants[60]
// 'normpath'
#define const_str_plain_normpath global_constants[61]
// 'exists'
#define const_str_plain_exists global_constants[62]
// 'isdir'
#define const_str_plain_isdir global_constants[63]
// 'isfile'
#define const_str_plain_isfile global_constants[64]
// 'listdir'
#define const_str_plain_listdir global_constants[65]
// 'stat'
#define const_str_plain_stat global_constants[66]
// 'close'
#define const_str_plain_close global_constants[67]
// 'getattr'
#define const_str_plain_getattr global_constants[68]
// '__cached__'
#define const_str_plain___cached__ global_constants[69]
// 'print'
#define const_str_plain_print global_constants[70]
// 'end'
#define const_str_plain_end global_constants[71]
// 'file'
#define const_str_plain_file global_constants[72]
// 'bytes'
#define const_str_plain_bytes global_constants[73]
// '.'
#define const_str_dot global_constants[74]
// '_'
#define const_str_underscore global_constants[75]
// '__loader__'
#define const_str_plain___loader__ global_constants[29]
// 'send'
#define const_str_plain_send global_constants[76]
// 'throw'
#define const_str_plain_throw global_constants[77]
// 'site'
#define const_str_plain_site global_constants[78]
// 'type'
#define const_str_plain_type global_constants[79]
// 'len'
#define const_str_plain_len global_constants[80]
// 'range'
#define const_str_plain_range global_constants[34]
// 'repr'
#define const_str_plain_repr global_constants[81]
// 'int'
#define const_str_plain_int global_constants[82]
// 'iter'
#define const_str_plain_iter global_constants[83]
// '__spec__'
#define const_str_plain___spec__ global_constants[84]
// '_initializing'
#define const_str_plain__initializing global_constants[85]
// 'parent'
#define const_str_plain_parent global_constants[86]
// 'types'
#define const_str_plain_types global_constants[87]
// 'ascii'
#define const_str_plain_ascii global_constants[88]
// 'punycode'
#define const_str_plain_punycode global_constants[89]
// '__main__'
#define const_str_plain___main__ global_constants[90]
// 'as_file'
#define const_str_plain_as_file global_constants[91]
// 'register'
#define const_str_plain_register global_constants[92]
// '__class_getitem__'
#define const_str_plain___class_getitem__ global_constants[93]
// 'reconfigure'
#define const_str_plain_reconfigure global_constants[94]
// 'encoding'
#define const_str_plain_encoding global_constants[95]
// 'line_buffering'
#define const_str_plain_line_buffering global_constants[96]
// '__match_args__'
#define const_str_plain___match_args__ global_constants[97]
// 'fileno'
